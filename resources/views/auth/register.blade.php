...
@section('content')
    ...
    <form action="{{ route('register') }}" method="POST" class="form-signin">
        ...
        <input type="text" id="phone_number" name="phone_number" class="form-control" placeholder="+7ХХХХХХХХХХ"
               required autofocus>
        <label for="email" class="sr-only">Email address</label>
        <input type="email" id="email" name="email" class="form-control" placeholder="Email address" required autofocus>
        <label for="password" class="sr-only">Password</label>
        <input type="password" id="password" style="margin-bottom: 0;" name="password" class="form-control"
